 ...
 useEffect(()=>{
    ...
    <div className={styles.timetrackmain}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-around', width: 'fit-content' }}>
                        ...
                        <div style={{ margin: '0px', borderLeft: '1px solid #e4eaee', padding: '0px 20px' ,cursor:"pointer"}}> <img  src={play} alt="error" width="20px" height="20px" /></div>
  ...
  <PopoverContent>
    ...
    <PopoverBody style={{backgroundColor:"#03a9f4",color:"white",cursor:"pointer"}} onClick={() => dispatch(removetask(elem._id))} >Delete</PopoverBody>
  </PopoverContent>
</Popover> 
